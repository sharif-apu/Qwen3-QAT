...
def run_w_vs_wa_comparison():
    ...
    acc_baseline, time_baseline = evaluate_accuracy(model_baseline, tokenizer, "Baseline FP16")
    ...
    results['experiments'].append({
        ...
        'compression_ratio': 1.0, 'avg_bits': 16.0, 'eval_time_seconds': time_baseline
    })
    ...
    acc_w, eval_time_w = evaluate_accuracy(model_w, tokenizer, "Weight-Only (W)")
    ...
    results['experiments'].append({
        ...
        'quantization_time_seconds': quant_time_w, 'eval_time_seconds': eval_time_w
    })
    ...
    acc_wa, eval_time_wa = evaluate_accuracy(model_wa, tokenizer, "Weight+Activation (W+A)")
    ...
    results['experiments'].append({
        ...
        'eval_time_seconds': eval_time_wa
    })
